...
public:
    ...
    void add_interfaced_vertex(int idx, double value, double r, int x, int y, std::string name="", Vertex_type type=Vertex_type::Logistic, std::string pic_name="", int pic_idx=0 );
